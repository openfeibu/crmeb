<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:63:"/home/vagrant/Code/crmeb/application/admin/view/index/index.php";i:1545062348;s:64:"/home/vagrant/Code/crmeb/application/admin/view/public/style.php";i:1545062348;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element admin_open">
                        <span>
                            <img alt="image" class="imgbox" src="<?php echo $site_logo; ?>" onerror="javascript:this.src='{__ADMIN_PATH}images/admin_logo.png';"/>
                        </span>
